...
namespace Domain.Data.Migrations
{
    ...
    [Migration("20170721172534_RemoveExternalType2")]
    partial class RemoveExternalType2
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Domain.Model.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("ListEnumId");

                    b.ToTable("ApplicationUser","Operations");
                });

            modelBuilder.Entity("Domain.Model.Models.ApplicationUserDetail", b =>
                {
                    ...
                    b.Property<long?>("SpouseCellPhone")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ApplicationUserDetail","Operations");
                });
            ...
            modelBuilder.Entity("Domain.Model.Models.ApplicationUser", b =>
                {
                    b.HasOne("Domain.Model.Models.ListEnum")
                        .WithMany("ExternalType")
                        .HasForeignKey("ListEnumId");
                });
            ...
            modelBuilder.Entity("Domain.Model.Models.ApplicationUserDetail", b =>
                {
                    b.HasOne("Domain.Model.Models.ApplicationUser", "ApplicationUser")
                        ...
                        .HasForeignKey("Domain.Model.Models.ApplicationUserDetail", "ApplicationUserId")
                        .HasConstraintName("FK_ApplicationUserDetail_ApplicationUser")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Domain.Model.Models.State", "State")
                        .WithOne("ApplicationUserDetail")
                        .HasForeignKey("Domain.Model.Models.ApplicationUserDetail", "StateId")
